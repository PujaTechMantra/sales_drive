    ...
    public function run(): void
    {
        //
         $permissions = [
            ...
            ['parent_name' => 'master_management', 'name' => 'progress_category_marking_list', 'route' => 'admin.student.progresslist'],
            ['parent_name' => 'master_management', 'name' => 'create_progress_category_marking', 'route' => 'admin.student.progressstore'],
            ['parent_name' => 'master_management', 'name' => 'edit_progress_category_marking', 'route' => 'admin.student.progressupdate'],
            ['parent_name' => 'master_management', 'name' => 'delete_progress_category_marking', 'route' => 'admin.student.progressdelete'],
            ...
            ['parent_name' => 'student_management', 'name' => 'import_student_mark_list', 'route' => 'admin.student-marks.importMarks'],
