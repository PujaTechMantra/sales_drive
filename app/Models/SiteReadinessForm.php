...
class SiteReadinessForm extends Model
{
    ...
    protected $fillable = ['slot_booking_id', 'distributor_code', 'distributor_name', 'full_address', 'office_phone_no',
        ...
        'regional_price_status', 'opening_stock_status', 'grn_invoice_status', 'sales_order_status', 'opening_points_status', 'distributor_name_remarks', 'distributor_code_remarks',
        'full_address_remarks', 'office_phone_no_remarks', 'city_remarks', 'state_remarks', 'zone_remarks',
        'contact_person_remarks', 'distributor_email_remarks', 'contact_person_phone_remarks', 'gst_number_remarks',
        'pan_number_remarks', 'so_name_remarks', 'so_contact_number_remarks', 'brands_remarks',
        'beat_name_remarks', 'beat_id_remarks', 'beat_type_remarks', 'region_code_remarks', 'region_csp_remarks',
        'region_name_remarks', 'beat_distributor_codes_remarks', 'employee_id_remarks', 'employee_label_remarks',
        'employee_name_remarks', 'designation_code_remarks', 'rm_employee_id_remarks', 'rm_designation_code_remarks',
        'state_code_remarks', 'employee_distributor_codes_remarks', 'employee_distributor_mapping_remarks', 'dsr_distributor_mapping_remarks',
        'beat_employee_mapping_remarks', 'supplier_distributor_mapping_remarks', 'outlet_sync_csp_remarks', 'outlet_lead_creation_remarks',
        'outlet_lead_approval_remarks', 'regional_price_remarks', 'opening_stock_remarks', 'grn_invoice_remarks', 'sales_order_remarks', 'opening_points_remarks'
    ];
