...
class SiteReadinessForm extends Model
{
    ...
    'opening_stock', 'grn_invoice', 'sales_order', 'opening_points', 'remarks', 'status', 'distributor_code_status', 'distributor_name_status', 'full_address_status', 'office_phone_no_status',
