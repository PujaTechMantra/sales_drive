    ...
    <div class="authentication-inner py-6 mx-4">
      ...
      <div class="card p-7">
        ...
        <div class="card-body mt-1">
          ...
          <form id="formAuthentication" class="mb-5" action="{{route('client.reset-password')}}" method="POST">
            @csrf
          ...
          <div class="text-center">
            <a href="{{route('client.login')}}" class="d-flex align-items-center justify-content-center">
